...
var contentlayer_config_default = makeSource({
  ...
  contentDirExclude: ["references-data.bib"],
  // Exclude .bib files
  ...
  mdx: {
    ...
    rehypePlugins: [
      ...
      // [rehypeCitation, { path: path.join(root, 'data') }], // Temporarily removed
...
//# sourceMappingURL=compiled-contentlayer-config-AS2NY7NS.mjs.map
